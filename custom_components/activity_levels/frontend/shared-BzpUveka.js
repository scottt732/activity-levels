import { t as e } from "./shared-0Kgc14T1.js";
import { $ as t, B as n, G as r, Ht as i, N as a, P as o, Ut as s, V as c, W as l, an as u, d, en as f, et as p, in as m, k as h, l as g, nn as _, nt as v, r as y, vn as b, w as x, x as S, yn as C } from "./shared-BezvItqW.js";
import { t as w } from "./shared-By8JNv_U.js";
//#region node_modules/.pnpm/three@0.185.1/node_modules/three/examples/jsm/controls/OrbitControls.js
var T = { type: "change" }, E = { type: "start" }, D = { type: "end" }, O = new i(), k = new p(), A = Math.cos(70 * c.DEG2RAD), j = new C(), M = 2 * Math.PI, N = {
	NONE: -1,
	ROTATE: 0,
	DOLLY: 1,
	PAN: 2,
...
}, P = 1e-6, F = class extends d {
	constructor(e, t = null) {
		super(e, t), this.state = N.NONE, this.target = new C(), this.cursor = new C(), this.minDistance = 0, this.maxDistance = Infinity, this.minZoom = 0, this.maxZoom = Infinity, this.minTargetRadius = 0, this.maxTargetRadius = Infinity, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -Infinity, this.maxAzimuthAngle = Infinity, this.enableDamping = !1, this.dampingFactor = .05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.keyRotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.zoomToCursor = !1, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = {
			LEFT: "ArrowLeft",
			UP: "ArrowUp",
			RIGHT: "ArrowRight",
			BOTTOM: "ArrowDown"
			...
			ONE: u.ROTATE,
			TWO: u.DOLLY_PAN
		}, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._cursorStyle = "auto", this._domElementKeyEvents = null, this._lastPosition = new C(), this._lastQuaternion = new v(), this._lastTargetPosition = new C(), this._quat = new v().setFromUnitVectors(e.up, new C(0, 1, 0)), this._quatInverse = this._quat.clone().invert(), this._spherical = new m(), this._sphericalDelta = new m(), this._scale = 1, this._panOffset = new C(), this._rotateStart = new b(), this._rotateEnd = new b(), this._rotateDelta = new b(), this._panStart = new b(), this._panEnd = new b(), this._panDelta = new b(), this._dollyStart = new b(), this._dollyEnd = new b(), this._dollyDelta = new b(), this._dollyDirection = new C(), this._mouse = new b(), this._performCursorZoom = !1, this._pointers = [], this._pointerPositions = {}, this._controlActive = !1, this._onPointerMove = L.bind(this), this._onPointerDown = I.bind(this), this._onPointerUp = R.bind(this), this._onContextMenu = G.bind(this), this._onMouseWheel = V.bind(this), this._onKeyDown = H.bind(this), this._onTouchStart = U.bind(this), this._onTouchMove = W.bind(this), this._onMouseDown = z.bind(this), this._onMouseMove = B.bind(this), this._interceptControlDown = K.bind(this), this._interceptControlUp = q.bind(this), this.domElement !== null && this.connect(this.domElement), this.update();
	}
	set cursorStyle(e) {
	...
	reset() {
		this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(T), this.update(), this.state = N.NONE;
	}
	pan(e, t) {
	...
	update(e = null) {
		...
		j.copy(t).sub(this.target), j.applyQuaternion(this._quat), this._spherical.setFromVector3(j), this.autoRotate && this.state === N.NONE && this._rotateLeft(this._getAutoRotationAngle(e)), this.enableDamping ? (this._spherical.theta += this._sphericalDelta.theta * this.dampingFactor, this._spherical.phi += this._sphericalDelta.phi * this.dampingFactor) : (this._spherical.theta += this._sphericalDelta.theta, this._spherical.phi += this._sphericalDelta.phi);
		let n = this.minAzimuthAngle, r = this.maxAzimuthAngle;
		isFinite(n) && isFinite(r) && (n < -Math.PI ? n += M : n > Math.PI && (n -= M), r < -Math.PI ? r += M : r > Math.PI && (r -= M), n <= r ? this._spherical.theta = Math.max(n, Math.min(r, this._spherical.theta)) : this._spherical.theta = this._spherical.theta > (n + r) / 2 ? Math.max(n, this._spherical.theta) : Math.min(r, this._spherical.theta)), this._spherical.phi = Math.max(this.minPolarAngle, Math.min(this.maxPolarAngle, this._spherical.phi)), this._spherical.makeSafe(), this.enableDamping === !0 ? this.target.addScaledVector(this._panOffset, this.dampingFactor) : this.target.add(this._panOffset), this.target.sub(this.cursor), this.target.clampLength(this.minTargetRadius, this.maxTargetRadius), this.target.add(this.cursor);
		let i = !1;
		...
		if (j.setFromSpherical(this._spherical), j.applyQuaternion(this._quatInverse), t.copy(this.target).add(j), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
			...
			if (this.object.isPerspectiveCamera) {
				...
				let t = new C(this._mouse.x, this._mouse.y, 0);
				...
				let r = new C(this._mouse.x, this._mouse.y, 0);
			...
			e !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position) : (O.origin.copy(this.object.position), O.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(O.direction)) < A ? this.object.lookAt(this.target) : (k.setFromNormalAndCoplanarPoint(this.object.up, this.target), O.intersectPlane(k, this.target))));
		} else if (this.object.isOrthographicCamera) {
		...
		return this._scale = 1, this._performCursorZoom = !1, i || this._lastPosition.distanceToSquared(this.object.position) > P || 8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > P || this._lastTargetPosition.distanceToSquared(this.target) > P ? (this.dispatchEvent(T), this._lastPosition.copy(this.object.position), this._lastQuaternion.copy(this.object.quaternion), this._lastTargetPosition.copy(this.target), !0) : !1;
	}
	_getAutoRotationAngle(e) {
		return e === null ? M / 60 / 60 * this.autoRotateSpeed : M / 60 * this.autoRotateSpeed * e;
	}
	_getZoomScale(e) {
		let t = Math.abs(e * .01);
	...
	_handleKeyDown(e) {
		...
		switch (e.code) {
			...
			case this.keys.LEFT:
				...
				break;
			case this.keys.RIGHT: e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(-M * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(-this.keyPanSpeed, 0), t = !0;
		}
...
function R(e) {
	switch (this._removePointer(e), this._pointers.length) {
		case 0:
			this.domElement.releasePointerCapture(e.pointerId), this.domElement.ownerDocument.removeEventListener("pointermove", this._onPointerMove), this.domElement.ownerDocument.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(D), this.state = N.NONE, this._cursorStyle === "grab" && (this.domElement.style.cursor = "grab");
			break;
		case 1:
...
function z(e) {
	...
	switch (t) {
		case n.DOLLY:
			...
			this._handleMouseDownDolly(e), this.state = N.DOLLY;
			break;
		case n.ROTATE:
			if (e.ctrlKey || e.metaKey || e.shiftKey) {
				if (this.enablePan === !1) return;
				this._handleMouseDownPan(e), this.state = N.PAN;
			} else {
				if (this.enableRotate === !1) return;
				this._handleMouseDownRotate(e), this.state = N.ROTATE;
			}
			break;
		case n.PAN:
			if (e.ctrlKey || e.metaKey || e.shiftKey) {
			...
			break;
		default: this.state = N.NONE;
	}
	this.state !== N.NONE && this.dispatchEvent(E);
}
function B(e) {
	switch (this.state) {
		case N.ROTATE:
...
function V(e) {
	this.enabled !== !1 && this.enableZoom !== !1 && this.state === N.NONE && (e.preventDefault(), this.dispatchEvent(E), this._handleMouseWheel(this._customWheelEvent(e)), this.dispatchEvent(D));
}
function H(e) {
	...
	switch (this._trackPointer(e), this._pointers.length) {
		case 1:
			switch (this.touches.ONE) {
				case u.ROTATE:
					if (this.enableRotate === !1) return;
					this._handleTouchStartRotate(e), this.state = N.TOUCH_ROTATE;
					break;
				case u.PAN:
					if (this.enablePan === !1) return;
					this._handleTouchStartPan(e), this.state = N.TOUCH_PAN;
					break;
				default: this.state = N.NONE;
			}
			break;
		case 2:
			switch (this.touches.TWO) {
				case u.DOLLY_PAN:
					...
					this._handleTouchStartDollyPan(e), this.state = N.TOUCH_DOLLY_PAN;
					break;
				case u.DOLLY_ROTATE:
					if (this.enableZoom === !1 && this.enableRotate === !1) return;
					this._handleTouchStartDollyRotate(e), this.state = N.TOUCH_DOLLY_ROTATE;
					break;
				default: this.state = N.NONE;
			}
			break;
...
function J(e, t) {
	let n = new _(e.footprint.map(([e, n]) => new b(e - t.x, n + t.z))), r = new x(n, {
		depth: e.high - e.low,
		bevelEnabled: !1,
		steps: 1
	});
...
var Y = class {
	constructor(e, n, r) {
		this.host = e, this.select = n, this.fail = r, this.scene = new f(), this.camera = new t(38, 1, .01, 1e3), this.raycaster = new s(), this.volumes = [], this.radius = 1, this.disposed = !1, this.lost = !1, this.pointer = null, this.resize = () => {
			...
			this.raycaster.setFromCamera(new b((e.clientX - n.left) / n.width * 2 - 1, -(e.clientY - n.top) / n.height * 2 + 1), this.camera);
		...
		let i = this.renderer.domElement;
		i.style.width = "100%", i.style.height = "100%", i.style.display = "block", i.setAttribute("aria-label", "3D house. Drag to rotate; use the camera controls and group list for keyboard access."), i.setAttribute("role", "img"), this.host.append(i), this.controls = new F(this.camera, i), this.controls.enableDamping = !1, this.controls.maxPolarAngle = Math.PI * .49, this.controls.addEventListener("change", this.draw), i.addEventListener("pointerdown", this.onPointerDown), i.addEventListener("pointermove", this.onPointerMove), i.addEventListener("pointerup", this.onPointerUp), i.addEventListener("pointercancel", this.onPointerCancel), i.addEventListener("webglcontextlost", this.onContextLost), this.observer = new ResizeObserver(this.resize), this.observer.observe(e), this.resize();
	}
	setParts(e) {
		if (this.clearParts(), !e.length) {
			this.draw();
			return;
		}
		let t = new y();
		for (let n of e) for (let [e, r] of n.footprint) t.expandByPoint(new C(e, n.low, -r)), t.expandByPoint(new C(e, n.high, -r));
		let n = t.getCenter(new C());
		this.radius = Math.max(t.getSize(new C()).length() / 2, .1);
		for (let t of e) {
			let e = J(t, n), i = new l(e, new r({
				color: 6342885,
				transparent: !0,
				opacity: .025,
				side: 2,
				depthWrite: !1
			})), s = new o(new S(e), new a({
				color: 9545396,
				transparent: !0,
				opacity: .4,
				depthWrite: !1
			}));
			t.container && (i.material.opacity = 0), this.scene.add(i, s), this.volumes.push({
				part: t,
				mesh: i,
				edges: s
			});
		}
		this.grid = new h(this.radius * 2.8, 16, 6914446, 6914446), this.grid.position.y = t.min.y - n.y - this.radius * .015, this.grid.material.transparent = !0, this.grid.material.opacity = .14, this.scene.add(this.grid), this.camera.near = Math.max(this.radius / 1e3, .001), this.camera.far = this.radius * 100, this.controls.minDistance = this.radius * .1, this.controls.maxDistance = this.radius * 30, this.cameraAction("reset");
	}
	setActivity(t, n, r) {
		for (let { part: i, mesh: a, edges: o } of this.volumes) {
			let s = e(t, i.id, n).ratio, c = i.id === r || i.ancestors.includes(r), l = s === null ? new g(8754849) : new g(6273746).lerp(new g(16759910), s);
			a.material.color.copy(l), a.material.opacity = i.container ? 0 : s === null ? .008 : .025 + s * .28, o.material.color.copy(c ? new g(16777215) : l), o.material.opacity = c ? 1 : (i.container ? .18 : .35) + (s ?? 0) * .55;
		}
		this.draw();
	}
	cameraAction(e) {
		if (e === "reset" || e === "top") {
			...
			let i = e === "top" ? new C(0, 1, 1e-4) : new C(1, .8, 1);
	...
	dispose() {
		if (this.disposed) return;
		this.disposed = !0, this.observer.disconnect(), this.controls.removeEventListener("change", this.draw), this.controls.dispose();
